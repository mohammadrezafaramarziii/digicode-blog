export default function RHFSelect({ label, name, register, options, isRequired, errors }) {
    ...
    return (
        <div className="textField relative">
            ...
            <select {...register(name)} id={name} className={`textField__input ${hasError ? "!border-red-600" : ""}`}>
                {options.map((option) => (
